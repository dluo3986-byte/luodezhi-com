...
const trips: Trip[] = [
  {
    ...
    days: [
      ...
      {
        day: 4,
        title: "Moncton, New Brunswick — Towel Dispute & TBD",
        highlights: [
          ...
          "Note to self: check the rack before grabbing a towel",
          "Written at 9:30 AM — day still unfolding, hoping for improvement",
        ],
      },
    ],
    upcomingPlans: [
